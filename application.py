...
def form2():
    ...
    if algo == 'Plot description':
        ...
        cosine_sim1_1 = np.load('assets/matrixs_meta/cosine_sim1_1_overview.npy')
        cosine_sim1_2 = np.load('assets/matrixs_meta/cosine_sim1_2_overview.npy')
        cosine_sim = np.concatenate((cosine_sim1_1, cosine_sim1_2))

        indices = pd.read_csv('assets/matrixs_meta/indices.csv')
        ...
        cosine_sim2_1 = np.load('assets/matrixs_meta/cosine_sim2_1_metadata.npy')
        cosine_sim2_2 = np.load('assets/matrixs_meta/cosine_sim2_2_metadata.npy')
        cosine_sim2 = np.concatenate((cosine_sim2_1, cosine_sim2_2))

        indices2 = pd.read_csv('assets/matrixs_meta/indices2.csv')
